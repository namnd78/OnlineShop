                            ...
                            <div class="card-body">
                                ...
                                <form action="updateproduct" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="number" name="categoryId" value="${product.category.id}" required />
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="releaseDate" type="date" required  value="${product.releaseDate}"/>
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <textarea class="editor" name="specification" id="content" value="${product.specification}"></textarea>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="number" name="stateId" value="${product.state.id}">
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-sm-12 mt-2 mb-2">
                                            <button type="submit" class="btn-2 btn">Save change</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
