...
public class HomeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> newProducts = pdao.getTop8NewProducts();
        List<Product> sellerProducts = pdao.getTop8SellerProducts();
        List<Product> saleProducts = pdao.getTop8SaleProducts();
