<%-- 
    Document   : categories
    Created on : Jul 18, 2022, 9:10:14 PM
    Author     : NamND
--%>
        ...
        <div class="position-relative bg-white d-flex p-0">
            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    <div class="navbar-nav w-100">
                        ...
                        <a href="categoriesmanage" class="nav-item nav-link active"><i class="fa-solid fa-sitemap"></i>Categories</a>
            ...
            <div class="content">
                <div class="container-fluid pt-4 px-4">
                    <div class="row g-4">
                        <div class="col-sm-6">
                            <a class="btn btn-sm btn-primary mb-2" href="addcategory">Create new category</a>
                                    ...
                                    <tbody>
                                        <c:forEach items="${categories}" var="c">
                                            <tr>
                                                <td>${c.id}</td>
                                                <td>${c.name}</td>
                                                <td><a class="btn btn-sm btn-primary" href="updatecategory?cid=${c.id}">Edit</a></td>
                                                <td><a class="btn btn-sm btn-primary" onclick="doDelete('${c.id}')">Delete</a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
